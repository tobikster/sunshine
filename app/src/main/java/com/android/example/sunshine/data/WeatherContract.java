...
public class WeatherContract {
	/**
	 * The name for the entire content provider, similar to the relationship between a domain name and its website. A
	 * convenient string to use for the content authority is the package name for the app, which is guaranteed to be
	 * unique on the device.
	 */
	public static final String CONTENT_AUTHORITY = "com.android.example.sunshine";

	/**
	 * Use {@link #CONTENT_AUTHORITY} to create the base of all URI's which apps will use to contact the content
	 * provider.
	 */
	...
	public static final class LocationEntry implements BaseColumns {
		...
		/** The location setting string that will be send to OpenWeatherMap as the location query. */
	...
	public static final class WeatherEntry implements BaseColumns {
		...
		/** Short description of the weather, as provided by API (e.g "clear"). */
		public static final String COLUMN_SHORT_DESC = "short_desc";

		/** Min temperature for the day (stored as float) */
		public static final String COLUMN_MIN_TEMP = "min";

		/** Max temperature for the day (stored as float) */
		...
		/** Wind speed stored as a float representing wind speed in mph */
